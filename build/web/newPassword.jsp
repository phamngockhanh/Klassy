            ...
            <div class="contents order-2 order-md-1">
                <div class="container">
                    <div class="row align-items-center justify-content-center">
                        <div class="col-md-7">
                            <h3 style="margin-left:155px">New Password</h3>
                            ...
                            <form action="newPasswordController" method="post">
                                ...
                                <div class="form-group last mb-3">
                                    ...
                                    <input type="password" required class="form-control form-control-lg" name="npass" />
                                </div>
                                
                                 <div class="form-group last mb-3">
                                    <label for="repassword">Re-Password</label>
                                    <input type="password" required class="form-control form-control-lg" name="cpass" />
                                </div>

                                <button type="submit" value="Log In" class="btn btn-outline-primary" style="margin-left:190px">Submit</button>
