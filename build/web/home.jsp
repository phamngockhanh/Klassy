  ...
  <head>
    ...
    <section class="section" id="menu">
        ...
        <c:forEach items="${requestScope.product}" var="f" >
                            ...
                            <div class="item">
                                <div class='card' style="background-image: url('assets/images/${f.image}');">
                                    <div class="price"><h6>$${f.price}</h6></div>
                                     <div class='info'>
                                             <h1 class='title'>${f.productName}</h1>
                                             <p class='description'>${f.descript}</p>
                                             <div class="main-text-button">
                                            <div class="scroll-to-section"><a href="productController?productId=${f.productId}">Make Order<i class="fa fa-angle-down"></i></a></div>
                                          </div>
                                     </div>
                            </div>
                         </div>
